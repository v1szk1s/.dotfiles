...
MUST_HAVE_AUX_PACKAGES=(
  ...
  wireguard-tools proton-vpn-gtk-app network-manager-applet
  fprintd imagemagick
)
PROGRAMMING=(
  go
...
echo "
/* Change menu background color for GTK3 apps like nm-applet */
.menu, .menuitem, menu, menuitem, .popup, .popup-menu {
    background-color: #1e1e2e;   /* your preferred background */
    color: #cdd6f4;              /* text color */
}

.menuitem:hover, menuitem:hover {
    background-color: #313244;   /* hover color */
}
